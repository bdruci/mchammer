...
TEST_CASE( "linearizeIndices" , "[Utility]") {
  ...
  vector<unsigned int> binSizes {10};
  ...
  // case 2d |-> 1d array
  vector<unsigned int> indices2d  {3,1};
  vector<unsigned int> binSizes2d {5,3};
  ...
  // case 3d |-> 1d array
  vector<unsigned int> indices3d  {3,1,1};
  vector<unsigned int> binSizes3d {5,3,2};
  ...
  vector<unsigned int> indices3d_2  {3,1,5};
  vector<unsigned int> binSizes3d_2 {5,3,6};
  ...
  vector<unsigned int> indices2d_c  {3,2};
  vector<unsigned int> binSizes2d_c {10,5};
